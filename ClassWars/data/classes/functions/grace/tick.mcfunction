...
execute as @a[scores={grace_combo_timer=0,grace_combo_count=3..}] at @s run playsound minecraft:entity.generic.splash player @s ~ ~ ~ 1 1
...
execute as @a[scores={grace_use_trident=1..,grace_combo_count=3}] at @s run playsound minecraft:entity.generic.splash player @s ~ ~ ~ 1 1
...
execute as @a[scores={grace_combo_count=5..}] run effect give @s minecraft:speed 1 3 true
execute as @a[scores={grace_combo_count=5..}] run effect give @s minecraft:resistance 1 1 true
execute as @a[scores={grace_combo_count=5..}] run effect give @s minecraft:jump_boost 1 0 true
