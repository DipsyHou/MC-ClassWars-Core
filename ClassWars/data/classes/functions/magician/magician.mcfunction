item replace entity @s weapon.mainhand with minecraft:stick{Unbreakable:1b,display:{Name:'{"text":"魔术棒","color":"blue","bold":true}'},Enchantments:[{id:"minecraft:knockback",lvl:3}],knockback_stick:1b} 1
